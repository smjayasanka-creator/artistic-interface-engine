...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      loan_application_status_history: {
        Row: {
          ...
          application_no: string;
          created_at: string;
          from_status: Database["public"]["Enums"]["loan_application_status"] | null;
          id: string;
          reason: string | null;
    ...
    Enums: {
      ...
      client_status: "pending_kyc" | "active" | "dormant" | "blacklisted" | "exited";
      ...
      fd_maturity_instruction: "payout" | "renew_principal" | "renew_principal_interest";
      fd_payout_option: "monthly" | "at_maturity";
      fd_penalty_type: "rate_reduction" | "reprice_minus_margin";
      fd_status: "pending" | "active" | "matured" | "prematurely_closed" | "renewed";
      fd_txn_type:
        | "opening"
        | "interest_payout"
        | "premature_closure"
      ...
      loan_status:
        ...
        | "closed"
        | "written_off";
      passbook_stock_status: "in_stock" | "partially_issued" | "exhausted" | "void";
      ...
      savings_channel: "branch" | "atm" | "ceft" | "internet_banking" | "mobile" | "api" | "other";
      ...
      savings_txn_type:
        ...
        | "closure"
        | "adjustment";
      staff_role: "loan_officer" | "branch_manager" | "teller" | "operations" | "admin";
      workflow_action_decision: "approve" | "decline" | "send_back";
      workflow_approver_kind: "role" | "branch_role" | "user";
      workflow_instance_status: "pending" | "approved" | "declined" | "cancelled";
...
export const Constants = {
  public: {
    Enums: {
      ...
      installment_state: ["upcoming", "due", "paid", "partial", "overdue", "waived", "cancelled"],
      interest_method: ["flat", "declining_balance"],
      introducer_commission_mode: ["cash", "bank_transfer", "credit_savings"],
      loan_application_status: [
        "draft",
