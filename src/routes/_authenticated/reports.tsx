...
function IncomeStatementTab() {
  return (
    <Card className="min-h-[16rem] flex flex-col items-center justify-center text-center">
      <div className="text-sm font-medium text-muted-foreground">Income Statement</div>
      <div className="text-xs text-faint mt-1">Coming soon — revenue, expenses and net profit summary.</div>
    </Card>
  );
}
...
function BalanceSheetTab() {
  return (
    <Card className="min-h-[16rem] flex flex-col items-center justify-center text-center">
      <div className="text-sm font-medium text-muted-foreground">Balance Sheet</div>
      <div className="text-xs text-faint mt-1">Coming soon — assets, liabilities and equity snapshot.</div>
    </Card>
  );
}
